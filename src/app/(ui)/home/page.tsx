      ...
      <div className="flex flex-col w-full h-full items-center bg-white">
        <div className="flex items-center w-full max-w-3xl flex-col lg:px-4 lg:bg-gray-200 h-full">
          {currentUser && currentUser.toLowerCase() == "admin@gmail.com" ? (
            <div
              className={`relative rounded-b-lg w-full flex flex-col h-fit items-center p-4 bg-white shadow-md transition-transform duration-300 `}
            >
              {/* Emoji Picker */}
              {isEmojiPickerOpen && (
                <div
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <textarea
                  className="w-full text-gray-500 xs:h-8 sm:h-12 md:h-24  lg:h-26 p-2 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-400"
                  value={text}
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex gap-2">
                  <button
                    className="flex items-center justify-center bg-yellow-400 p-2 w-10 h-10 rounded-full hover:bg-yellow-600 transition"
                    onClick={() => setIsEmojiPickerOpen((prev) => !prev)}
                  >
                    <FaSmile color="white" />
                  </button>
                  <button
                    className="flex items-center justify-center w-10 h-10  bg-green-500 p-2 rounded-full hover:bg-green-600 transition"
                    onClick={() =>
                        ...
                        <div className="flex  gap-4  justify-between px-4">
                          ...
                          <div className="flex justify-end space-x-4 mt-2">
                            <button
                              ...
                              onClick={() =>
                                toggleComments(post.id, post.docId)
                              }
                            >
